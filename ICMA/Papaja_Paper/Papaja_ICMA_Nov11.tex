...
\title{The title}
\author{Abhi Patel\textsuperscript{1}}
\date{}
...
The authors made the following contributions. Abhi Patel: Conceptualization, Writing - Original Draft Preparation, Writing - Review \& Editing.

Correspondence concerning this article should be addressed to Abhi Patel, Postal address. E-mail: \href{mailto:ap2101@scarletmail.rutgers.edu}{\nolinkurl{ap2101@scarletmail.rutgers.edu}}
...
\begin{figure}
\centering
\includegraphics{Papaja_ICMA_Nov11_files/figure-latex/chick-plot-1.pdf}
\caption{\label{fig:chick-plot}Each chick was weighed every other day from birth to day 20 and on day 21. This plot shows the weight of each chick (y-axis) for each day they were measured (x-axis). Each point is one measurement.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Papaja_ICMA_Nov11_files/figure-latex/red-plot-1.pdf}
\caption{\label{fig:red-plot}Plot 2}
\end{figure}

There is a significant difference in the average weight of chicks who received Diet 1 compared \(\Delta M = -40.30\), 95\% CI \([-57.62, -22.99]\), \(t(175.92) = -4.59\), \(p < .001\).
